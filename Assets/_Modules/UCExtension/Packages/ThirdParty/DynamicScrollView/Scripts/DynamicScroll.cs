...
namespace dynamicscroll
{
    ...
    {      
        ...
        public void MoveToIndex(int index, float? totalTime = null, float? timePerElement = null)
        {
            ...
            forceMoveTween = (mIsHorizontal ? ScrollRect.content.DOAnchorPosX(pos, time) : ScrollRect.content.DOAnchorPosY(pos, time)).SetEase(Ease.Linear);
        }
        public void SetIndex(int index)
        {
            ...
            if (mIsHorizontal)
            {
                ScrollRect.content.anchoredPosition = new Vector2(pos,ScrollRect.content.anchoredPosition.y);
            }
            else
            {
                ScrollRect.content.anchoredPosition = new Vector2(ScrollRect.content.anchoredPosition.y,pos);
