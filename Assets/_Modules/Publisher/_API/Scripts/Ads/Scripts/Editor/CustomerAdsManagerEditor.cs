...
//                    GUILayout.Space(5);
//                    adManager.androidSetting.BannerPosition = (BannerPosition)EditorGUILayout.EnumPopup("Banner Position", adManager.androidSetting.BannerPosition);
//                    GUILayout.Space(5);
...
//                    adManager.androidSetting.IsUseAppOpenAd = EditorGUILayout.Toggle("Use App Open Ads", adManager.androidSetting.IsUseAppOpenAd);
//                    if (adManager.androidSetting.IsUseAppOpenAd)
//                    {
//                        adManager.androidSetting.AOA_ID_APPLOVIN = EditorGUILayout.TextField("ID AOA", adManager.androidSetting.AOA_ID_APPLOVIN.Trim());
//                    }
//                }
//                GUILayout.Space(5);
...
//                }
//                GUILayout.Space(5);
//                adManager.androidSetting.SkipAOAInFirstTimeLogin = EditorGUILayout.Toggle("Skip AOA In First Time Login", adManager.androidSetting.SkipAOAInFirstTimeLogin);
//                GUILayout.Space(5);
...
//                    {
//                        adManager.iosSetting.AOA_ID_APPLOVIN = EditorGUILayout.TextField("ID AOA", adManager.iosSetting.AOA_ID_APPLOVIN.Trim());
//                    }
//                }
//                GUILayout.Space(5);
