...
public class MoneyManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        btnReward.onClick.AddListener(OpenReward);
    }

    void OpenReward() 
    {
        GUIController.Ins.Open<RewardGUI>();
    }
    ...
    private void ShowFloatingText(float amount, Color textColor)
    {
        ...
        floatText.transform.localPosition = startPos; // Đưa về vị trí ban đầu
        floatText.transform.DOLocalMoveY(floatText.transform.localPosition.y + 50, 1f).SetEase(Ease.OutQuad); // Di chuyển lên trên
